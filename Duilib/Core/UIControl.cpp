...
void CControlUI::PaintBorder(HDC hDC) {
    if(m_rcBorderSize.left > 0 && (m_dwBorderColor != 0 || m_dwFocusBorderColor != 0 || m_dwDisableBorderColor != 0)) {
        if( m_cxyBorderRound.cx > 0 || m_cxyBorderRound.cy > 0 ) { //画圆角边框
            if(!IsEnabled() && m_dwDisableBorderColor != 0)
                CRenderEngine::DrawRoundRect(hDC, m_rcItem, m_rcBorderSize.left, m_cxyBorderRound.cx, m_cxyBorderRound.cy, GetAdjustColor(m_dwDisableBorderColor), m_nBorderStyle);
            ...
            if (m_rcBorderSize.right == m_rcBorderSize.left && m_rcBorderSize.top == m_rcBorderSize.left && m_rcBorderSize.bottom == m_rcBorderSize.left) {
                if (!IsEnabled() && m_dwDisableBorderColor != 0)
                    CRenderEngine::DrawRect(hDC, m_rcItem, m_rcBorderSize.left, GetAdjustColor(m_dwDisableBorderColor), m_nBorderStyle);
                else if (IsFocused() && m_dwFocusBorderColor != 0)
                ...
                if(m_rcBorderSize.left > 0) {
                    ...
                    if (!IsEnabled() && m_dwDisableBorderColor != 0)
                        CRenderEngine::DrawLine(hDC, rcBorder, m_rcBorderSize.left, GetAdjustColor(m_dwDisableBorderColor), m_nBorderStyle);
                    else if (IsFocused() && m_dwFocusBorderColor != 0)
                ...
                if(m_rcBorderSize.top > 0) {
                    ...
                    if (!IsEnabled() && m_dwDisableBorderColor != 0)
                        CRenderEngine::DrawLine(hDC, rcBorder, m_rcBorderSize.top, GetAdjustColor(m_dwDisableBorderColor), m_nBorderStyle);
                    else if (IsFocused() && m_dwFocusBorderColor != 0)
                ...
                if(m_rcBorderSize.right > 0) {
                    ...
                    rcBorder.right  = rcBorder.left;
                    if (!IsEnabled() && m_dwDisableBorderColor != 0)
                        CRenderEngine::DrawLine(hDC, rcBorder, m_rcBorderSize.right, GetAdjustColor(m_dwDisableBorderColor), m_nBorderStyle);
                    else if (IsFocused() && m_dwFocusBorderColor != 0)
                ...
                if(m_rcBorderSize.bottom > 0) {
                    ...
                    rcBorder.right -= m_rcBorderSize.right;
                    if (!IsEnabled() && m_dwDisableBorderColor != 0)
                        CRenderEngine::DrawLine(hDC, rcBorder, m_rcBorderSize.bottom, GetAdjustColor(m_dwDisableBorderColor), m_nBorderStyle);
                    else if (IsFocused() && m_dwFocusBorderColor != 0)
