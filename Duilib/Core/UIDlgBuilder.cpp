    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
        ...
        //树控件XML解析
            ...
            case 6:
                ...
                else if (_tcsicmp(pstrClass, DUI_CTR_LISTEX) == 0)           pControl = new CListExUI;
                break;
            case 7:
            ...
            case 8:
                ...
                else if (_tcsicmp(pstrClass, DUI_CTR_GROUPBOX) == 0)		  pControl = new CGroupBoxUI;
                break;
            case 9:
            ...
            case 16:
                ...
                break;
            case 17:
                if (_tcsicmp(pstrClass, DUI_CTR_LISTEXTEXTELEMENT) == 0)  pControl = new CListExTextElementUI;
                break;
            case 20:
                if (_tcsicmp(pstrClass, DUI_CTR_LISTCONTAINERELEMENT) == 0)  pControl = new CListContainerElementUI;
                break;
            case 23:
                if (_tcsicmp(pstrClass, DUI_CTR_LISTCONTAINERHEADERITEM) == 0)  pControl = new CListContainerHeaderItemUI;
                break;
            }
