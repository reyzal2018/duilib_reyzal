...
class ReceiverImpl;
class DUILIB_API ObserverImpl : public ObserverImplBase {
...
////////////////////////////////////////////////////
class DUILIB_API ReceiverImpl : public ReceiverImplBase {
public:
    ReceiverImpl() {
...
class DUILIB_API CMenuWnd : public CWindowWnd, public ReceiverImpl, public INotifyUI, public IDialogBuilderCallback {
public:
