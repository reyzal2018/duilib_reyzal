...
LRESULT CComboWnd::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    //+reyzal 2017年10月12日 23:39:41 如果处理某个事件的时候sendnotify阻塞了，那么可能到这里时窗口已经销毁了，直接返回。
...
CComboUI::CComboUI() : m_pWindow(NULL), m_iCurSel(-1), m_uButtonState(0), m_bShowShadow(false) {
